...
using CarInsurance4.Models;

namespace CarInsurance4.Controllers
{
    public class InsureeController : Controller
    {
        ...
        public decimal CalculateQuota(Insuree Tables)
        {
            decimal baseCost = 50;
